...
public class PlatformManager : MonoBehaviour
{
    ...
    private bool oneFinger, twoFinger;
    ...
    private void Update()
    {
        ...
        if(oneFinger && !EventSystem.current.IsPointerOverGameObject())
        {
            ...
            if(touch.phase == TouchPhase.Began)
            {
                if(Frame.Raycast(touch.position.x, touch.position.y, raycastFilter, out hit))
                {
                    ...
                    if(!platformSpawned)
                    {
                        ...
                        feedbackText.text = "Platform spawned.";
                    ...
                    else
                    {
                        ...
                        if(raycastHit.transform.tag == "platform" && !overlapping)
                        {
                            ...
                            feedbackText.text = "blockname: " + buildingBlock;
            ...
            {
                carrier.transform.position = new Vector3(carrier.transform.position.x, carrier.transform.position.y, carrier.transform.position.z);
